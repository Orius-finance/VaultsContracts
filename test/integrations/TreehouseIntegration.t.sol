...
contract SwellSimpleStakingIntegrationTest is Test, MerkleTreeHelper {
    ...
    function setUp() external {
        ...
        rawDataDecoderAndSanitizer = address(new OnlyTreehouseDecoderAndSanitizer(address(oriusVault)));
    ...
    function testTreehouseIntegration() external {
        ...
        targetData[1] = abi.encodeWithSignature(
            "deposit(address,uint256)", getAddress(sourceChain, "WSTETH"), 1_000e18, address(oriusVault)
        );
        ...
        assertEq(
            ...
            999.5e18,
            "OriusVault should have received 1,000 WSTETH minus fee"
        );
    }
