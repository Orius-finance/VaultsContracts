...
contract SwellSimpleStakingIntegrationTest is Test, MerkleTreeHelper {
    ...
    function testSatlayerStakingIntegrationGeneric() external {
        deal(getAddress(sourceChain, "LBTC"), address(oriusVault), 1e8);
        ...
        targetData[1] = abi.encodeWithSignature(
            "depositFor(address,address,uint256)", getAddress(sourceChain, "LBTC"), oriusVault, 1e8
        );
        ...
        assertEq(
            ...
            1e8,
            "OriusVault should have received 1 LBTC"
        );
    }
