...
contract ElixirWithdrawIntegrationTest is Test, MerkleTreeHelper {
    ...
    function testElixirWithdrawIntegration() external {
        // Give OriusVault some sdeUSD.
        uint256 assets = 100_000e18;
        deal(getAddress(sourceChain, "sdeUSD"), address(oriusVault), assets);
        ...
        (uint104 end, uint152 amount) = sdeUSD.cooldowns(address(oriusVault));
        ...
        targetData[0] = abi.encodeWithSignature("unstake(address)", address(oriusVault));
        ...
        assertEq(
            getERC20(sourceChain, "deUSD").balanceOf(address(oriusVault)),
            amount,
            "OriusVault should have received unstaked deUSD."
        );
    }
