...
contract LineaBridgeIntegrationTest is Test, MerkleTreeHelper {
    ...
    function testBridgingToLineaETH() external {
        ...
        targetData[0] = abi.encodeWithSignature("sendMessage(address,uint256,bytes)", oriusVault, 0, hex"");
    ...
    function testBridgingToLineaERC20() external {
        ...
        targetData[1] = abi.encodeWithSignature(
            "bridgeToken(address,uint256,address)", getAddress(sourceChain, "DAI"), 100e18, oriusVault
        );
    ...
    function testBridgingToMainnetETH() external {
        ...
        targetData[0] = abi.encodeWithSignature("sendMessage(address,uint256,bytes)", oriusVault, fee, hex"");
