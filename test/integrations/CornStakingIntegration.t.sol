...
contract CornStakingIntegrationTest is Test, MerkleTreeHelper {
    ...
    function testCornStakingIntegrationWBTC() external {
        deal(getAddress(sourceChain, "WBTC"), address(oriusVault), 1_000e8);
        ...
        assertEq(
            getERC20(sourceChain, "WBTC").balanceOf(address(oriusVault)),
            1_000e8,
            "OriusVault should have received 1,000 WBTC"
        );
    }

    function testCornStakingIntegrationGeneric() external {
        deal(getAddress(sourceChain, "LBTC"), address(oriusVault), 1_000e8);
        ...
        assertEq(
            getERC20(sourceChain, "LBTC").balanceOf(address(oriusVault)),
            1_000e8,
            "OriusVault should have received 1,000 LBTC"
        );
    }
